                ...
                case 1: {
                    switch (control) {
                        case 1:
                            ...
                            double precioLote1 = s.nextDouble();
                            System.out.println("-Introduce las  unidades = ");
                            int unidadesLote1 = s.nextInt();
                            Lote l = new Lote(precioLote1, unidadesLote1, new GregorianCalendar(), fechaFabricacion.add(Calendar.MONTH, 1));
                            break;
                        case 2:
                            ...
                            System.out.println("-Introduzca el precio del medicamento = ");
                            double precioLote2 = s.nextDouble();
                            System.out.println("-Introduce las  unidades = ");
                            int unidadesLote2 = s.nextInt();
                            Lote l2 = new Lote(precioLote2, unidadesLote2, new GregorianCalendar(), fechaFabricacion.add(Calendar.MONTH, 1));
                            break;
                    }
                }
            }
